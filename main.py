...
def synthesize(ref_audio_path, ref_text, target_text, output_path, speed):
    ...
    synthesis_result = tts.synthesize_target_speech(ref_artifacts, target_text, how_to_cut="凑四句一切")
